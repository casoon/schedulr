...
pub use model::{
    ...
    ParticipantConflictPolicy, ParticipantGroup, ParticipantGroupId, ParticipantId,
    ...
    SoftGoal, SoftGoalKind, Solution, SolveResult, SolveStatistics, SolveStatus, TimeWindow,
